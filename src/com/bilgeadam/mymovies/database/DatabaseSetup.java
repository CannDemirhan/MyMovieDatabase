package com.bilgeadam.mymovies.database;
...
import java.sql.Statement;
 ...
 public class DatabaseSetup {
	 ...
	 /*
	  * Bu metod sadece veri tabanının sıfırdan yaratılması için kullanılmalı. İçinde gerçek veri
	  * olan bir veri tabanınız varsa sadece tablo ekleme veya ALTER ile var olan tablolarda değişiklikler yapabilirsıniz
	  */
	public void execute () {
