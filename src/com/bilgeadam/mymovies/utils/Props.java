package com.bilgeadam.mymovies.utils;
...
public class Props {
	...
	private Properties getProperties() {
		if (this.props == null) {
			...
			try {
				this.props.load(new FileInputStream(propsFilePath)); //readıng a file as byte stream
				//this.props.load(new FileReader(propsFilePath)); // readıng a file as ASCII
			}
